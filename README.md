<h1 align="center">Martian Robots</h1>

## 🔧 Installation 

1. Make sure you have [GO](https://go.dev/) for this project.
2. To initialize the program you should use:
```text
    go build ./cmd/main.go && ./main 
```

## 🚀 Run All Tests
The following should be run to initialize the tests of each service:
```text
    go test ./... 
```
With vendor:
